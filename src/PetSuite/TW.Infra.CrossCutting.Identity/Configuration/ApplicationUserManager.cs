...
namespace TW.Infra.CrossCutting.Identity.Configuration
{
    //É o IdentityConfig nos exemplos
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
            ...
            IOwinContext context)
        {
            ...
            manager.UserValidator = new UserValidator<ApplicationUser>(manager)
            {
                ...
                RequireUniqueEmail = true //não deixa cadastrar o mesmo email para usuários diferentes.
            };
        ...
        public async Task<IdentityResult> SignInClientAsync(ApplicationUser user, string clientKey)
        {
            ...
            {
                throw new ArgumentNullException("clientKey"); //nome do browser. A partir disso podemos saber quais browsers estão conectados e coneguimos desconectá-los.
            }
