...
using TW.PetSuite.UI.MVC.ViewModels;
using TW.Infra.CrossCutting.Identity;
...
namespace TW.PetSuite.UI.MVC.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private async Task SignInAsync(ApplicationUser user, bool isPersistent)
        {
            ...
            await UserManager.ResetAccessFailedCountAsync(user.Id); //Uma vez que o usuário conseguiu logar, zeramos o contador de vezes que tentou acessar.
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    //monta o email e automaticamente já envia.
                    ...
                    ViewBag.Link = callbackUrl; //Link gerado para o usuário clicar. Para testes.
